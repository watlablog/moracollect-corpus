...
現在は「50音」と「5種類の"ん"」のジャンルが利用できます。

![トップページ](img/002_top.png)

2. `収録する音声` 画面でプロンプトを選びます。
`5種類の"ん"` では、表示された単語をそのまま選びます。

3. `5種類の"ん"` を選んだ場合は、各語を自然な速さで1回読んでください。
「ん」だけを強調せず、単語全体を自然に発話します。
...
5. 5秒以内に発話します。
6. 必要なら `停止` を押して録音を終了します。
7. 録音後に再生プレイヤーで音声を確認します。
